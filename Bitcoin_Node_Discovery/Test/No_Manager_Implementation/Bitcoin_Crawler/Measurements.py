...
class Measurements:
    ...
    def add_process_ip_stat(self, stat, nb_query, thread_nb):
        ...
        self.acquire_lock(PROCESS_IP_STAT_LOCKER)
    ...
    def add_peer_bitcoin_handshake_duration(self, ip, handshake_duration):
        ...
        self.acquire_lock(PEERS_BITCOIN_HANDSHAKE_DURATION_LOCKER)
    ...
    def add_peer_tcp_handshake_duration(self, ip, handshake_duration):
        ...
        self.acquire_lock(PEERS_TCP_HANDSHAKE_DURATION_LOCKER)
    ...
    def add_peer_queried(self, ip, nb):
        ...
        self.acquire_lock(PEERS_QUERIED_NB_LOCKER)
    ...
    def add_active_peer(self, ip):
        ...
        self.acquire_lock(ACTIVE_PEERS_LOCKER)
    ...
    def add_connection_failed_stat(self, reason):
        ...
        self.acquire_lock(CONNECTION_FAILED_STAT_LOCKER)
    ...
    def add_ip_service(self, ip, service):
        ...
        self.acquire_lock(SERVICE_STAT_LOCKER)
    ...
    def add_version_stat(self, version):
        ...
        self.acquire_lock(VERSION_STAT_LOCKER)
