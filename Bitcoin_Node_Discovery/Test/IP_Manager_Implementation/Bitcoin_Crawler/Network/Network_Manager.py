...
class Network_Manager(Thread):
    ...
    def __init__(self, src_ip, src_port, src_service, network, measurements_manager, displayer, thread_id, ip_manager,
