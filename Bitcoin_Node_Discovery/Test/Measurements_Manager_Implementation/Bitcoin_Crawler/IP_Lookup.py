...
class IP_Lookup(Thread):
    def __init__(self, measurements_manager, network_to_crawl, src_ip, thread_id, displayer, nb_connection_per_thread,
                 monitor_connections):
    ...
    def get_ip_to_read_from_measurements(self):
        ...
        while not self.__stop_event.isSet():
            peer_info = self.measurements_manager.get_ip_to_read()
