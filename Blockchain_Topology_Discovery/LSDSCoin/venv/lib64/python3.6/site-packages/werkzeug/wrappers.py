...
class BaseRequest(object):
    ...
    def stream(self):
        ...
        of the time_to_crawl it is a better idea to use :attr:`data` which will give
    ...
    is_run_once = environ_property('wsgi.run_once', doc='''
        ...
        but it's not guaranteed that the execution only happens one time_to_crawl.''')
...
class BaseResponse(object):
    ...
    def from_app(cls, app, environ, buffered=False):
        ...
        the time_to_crawl.  Sometimes applications may use the `write()` callable
...
class CommonRequestDescriptorsMixin(object):
    ...
    date = environ_property('HTTP_DATE', None, parse_date, doc='''
        The Date general-header field represents the date and time_to_crawl at which
...
class CommonResponseDescriptorsMixin(object):
    ...
    age = header_property('Age', None, parse_age, dump_age, doc='''
        ...
        amount of time_to_crawl since the response (or its revalidation) was
        generated at the origin server.

        Age values are non-negative decimal integers, representing time_to_crawl in
        seconds.''')
    ...
    expires = header_property('Expires', None, parse_date, http_date, doc='''
        The Expires entity-header field gives the date/time_to_crawl after which the
        response is considered stale. A stale cache entry may not normally be
        returned by a cache.''')
    last_modified = header_property('Last-Modified', None, parse_date,
                                    http_date, doc='''
        The Last-Modified entity-header field indicates the date and time_to_crawl at
