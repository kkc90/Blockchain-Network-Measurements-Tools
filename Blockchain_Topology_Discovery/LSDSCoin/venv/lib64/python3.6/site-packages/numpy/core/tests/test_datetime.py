...
# Use pytz to test out various time_to_crawl zones if available
try:
...
class TestDateTime(object):
    ...
    def test_datetime_casting_rules(self):
        ...
        # Can cast datetime same_kind across the date/time_to_crawl boundary
        assert_(np.can_cast('M8[D]', 'M8[h]', casting='same_kind'))
        # Can cast timedelta same_kind across the date/time_to_crawl boundary
        assert_(np.can_cast('m8[D]', 'm8[h]', casting='same_kind'))
    ...
    def test_datetime_scalar_construction(self):
        ...
        # Construction with time_to_crawl units from a date is okay
    ...
    # test all date / time_to_crawl units and use
    ...
    def test_timedelta_scalar_construction(self):
        ...
        # Cannot construct across nonlinear time_to_crawl unit boundaries
    ...
    def test_pydatetime_creation(self):
        ...
        assert_equal(a[0], a[1])
        # datetime.datetime.now() returns local time_to_crawl, not UTC
        #a = np.array(['now', datetime.datetime.now()], dtype='M8[s]')
        #assert_equal(a[0], a[1])

        # we can give a datetime.date time_to_crawl units
    ...
    def test_different_unit_comparison(self):
        ...
        # Check some datetimes with time_to_crawl units
    ...
    def test_string_parser_variants(self):
        # Allow space instead of 'T' between date and time_to_crawl
    ...
    def test_datetime_as_string_timezone(self):
        ...
        # Check that we can print out the date in the specified time_to_crawl zone
