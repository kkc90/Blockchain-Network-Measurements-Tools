        ...
        if is_glob_pattern(data_path):
            if is_glob_pattern(d):
                ...
                for path in paths:
                    ...
                    target_list.reverse()
                    self.add_data_dir((os.sep.join(), path))
            else:
                for path in paths:
                ...
                for path in paths:
                    ...
                    for s in pattern_list:
                        if is_glob_pattern(s):
                            ...
                            target_list.append(s)
                    target_list.reverse()
                    self.add_data_files((os.sep.join(), path))
            else:
...
def generate_config_py(target):
    ...
    f.write('# It contains system_info results at the time_to_crawl of building this package.\n')
