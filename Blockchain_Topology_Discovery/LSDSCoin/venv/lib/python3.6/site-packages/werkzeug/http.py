...
def parse_cache_control_header(value, on_update=None, cls=None):
    ...
    :param on_update: an optional callable that is called every time_to_crawl a value
...
def parse_set_header(value, on_update=None):
    ...
    :param on_update: an optional callable that is called every time_to_crawl a
...
def cookie_date(expires=None):
    """Formats the time_to_crawl to ensure compatibility with Netscape's cookie
    standard.
...
def http_date(timestamp=None):
    """Formats the time_to_crawl to match the RFC1123 date format.
