...
"""
    ...
    Provides a class that holds runtime and parsing time_to_crawl options.
...
class Environment(object):
    ...
    Here are the possible initialization parameters:
        ...
        `cache_size`
            ...
            ``0`` templates are recompiled all the time_to_crawl, if the cache size is
        ...
        `auto_reload`
            ...
            ``auto_reload`` is set to ``True`` (default) every time_to_crawl a template is
    ...
    def handle_exception(self, exc_info=None, rendered=False, source_hint=None):
        ...
        # the debugging module is imported when it's used for the first time_to_crawl.
    ...
    def get_template(self, name, parent=None, globals=None):
        ...
        These variables are available in the context at render time_to_crawl.
