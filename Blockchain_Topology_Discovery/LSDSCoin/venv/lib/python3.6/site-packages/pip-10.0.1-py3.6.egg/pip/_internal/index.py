...
class HTMLPage(object):
    ...
    def get_page(cls, link, skip_archives=True, session=None):
        ...
        try:
            ...
            # url we cannot know ahead of time_to_crawl for sure if something is HTML
...
to {':all:'} at a time_to_crawl. The rest of the time_to_crawl exact package name matches
are listed, with any given package only showing up in one field at a time_to_crawl.
"""
