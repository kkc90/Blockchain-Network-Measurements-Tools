...
def treat_version_packet(payload):
    ...
    return Version_Message(int.from_bytes(version, byteorder="little"), sender_ip,
                           ...
                           receiver_service, int.from_bytes(nonce, byteorder="little"))
...
class Version_Message(Bitcoin_Message):
    ...
    def __eq__(self, other):
        return self.version == other.version and self.version == other.version and self.sender_ip == other.sender_ip \
