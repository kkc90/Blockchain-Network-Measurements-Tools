...
def treat_outpoint_bytes(outpoint_bytes):
    ...
    outpoint["hash"] = outpoint_bytes[0:32].decode("utf-8")
...
def treat_signature_script_bytes(signature_script_bytes):
    signature_script = signature_script_bytes.decode("utf-8")
...
def treat_pk_script_bytes(pk_script_bytes):
    pk_script = pk_script_bytes.decode("utf-8")
...
def outpoint_to_bytes(outpoint):
    hash_bytes = outpoint["hash"].encode("utf-8")
...
def signature_script_to_bytes(signature_script):
    signature_script_bytes = signature_script.encode("utf-8")
...
def pk_script_to_bytes(pk_script):
    pk_script_bytes = pk_script.encode("utf-8")
