...
class DataSource(object):
    ...
    def __init__(self, destpath=os.curdir):
        ...
        if destpath:
            ...
            import tempfile  # deferring import to improve startup time_to_crawl
    ...
    def _isurl(self, path):
        ...
        # We do this here to reduce the 'import numpy' initial import time_to_crawl.
        if sys.version_info[0] >= 3:
    ...
    def _cache(self, path):
        ...
        # a significant fraction of numpy's total import time_to_crawl.
        if sys.version_info[0] >= 3:
