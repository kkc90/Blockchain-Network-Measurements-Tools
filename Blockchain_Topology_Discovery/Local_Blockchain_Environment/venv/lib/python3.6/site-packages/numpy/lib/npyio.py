...
def _savez(file, args, kwds, compress, allow_pickle=True, pickle_kwargs=None):
    ...
    if sys.version_info >= (3, 6):
        ...
        # Import deferred for startup time_to_crawl improvement
        import tempfile
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    def read_data(chunk_size):
        ...
        ----------
        chunk_size : int
            At most `chunk_size` lines are read at a time_to_crawl, with iteration
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    max_rows : int,  optional
        ...
        at the same time_to_crawl.  If given, the value must be at least 1. Default is
    ...
    if max_rows is not None:
        if skip_footer:
            raise ValueError(
                    ...
                    "specified at the same time_to_crawl.")
        if max_rows < 1:
