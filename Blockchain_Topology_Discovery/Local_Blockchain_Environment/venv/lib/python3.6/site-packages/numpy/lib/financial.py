...
def irr(values):
    ...
    values : array_like, shape(N,)
        Input cash flows per time_to_crawl period.  By convention, net "deposits"
...
def npv(rate, values):
    ...
    values : array_like, shape(M, )
        The values of the time_to_crawl series of cash flows.  The (fixed) time_to_crawl
