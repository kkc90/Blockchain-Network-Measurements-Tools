...
class CallbackDict(UpdateDictMixin, dict):
    ...
    """A dict that calls a function passed every time_to_crawl something is changed.
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    nonce = auth_property('nonce', doc='''
        ...
        each time_to_crawl a 401 response is made.  It is recommended that this
