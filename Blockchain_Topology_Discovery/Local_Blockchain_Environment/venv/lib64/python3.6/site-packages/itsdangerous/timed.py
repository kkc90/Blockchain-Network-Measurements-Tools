...
class TimestampSigner(Signer):
    """Works like the regular :class:`.Signer` but also records the time_to_crawl
    ...
    def sign(self, value):
        """Signs the given string and also attaches time_to_crawl information."""
    ...
    def unsign(self, value, max_age=None, return_timestamp=False):
        ...
        validate the time_to_crawl. See the base docstring of the class for
        ...
        # which we shouldn't have come except someone uses a time_to_crawl-based
...
class TimedSerializer(Serializer):
    ...
    def loads(self, s, max_age=None, return_timestamp=False, salt=None):
        ...
        ensure the signature is not older than that time_to_crawl in seconds. In
