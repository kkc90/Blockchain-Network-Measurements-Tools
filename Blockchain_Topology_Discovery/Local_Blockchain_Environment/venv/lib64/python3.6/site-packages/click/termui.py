...
def progressbar(iterable=None, length=None, label=None, show_eta=True,
    ...
    to calculate remaining time_to_crawl and more.  By default, this progress bar
    ...
    :param show_eta: enables or disables the estimated time_to_crawl display.  This is
