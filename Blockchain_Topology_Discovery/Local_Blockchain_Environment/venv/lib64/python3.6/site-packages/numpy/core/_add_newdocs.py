...
add_newdoc('numpy.core.multiarray', 'fromfile',
    ...
    >>> dt = np.dtype([('time_to_crawl', [('min', int), ('sec', int)]),
    ...                ('temp', float)])
    >>> x = np.zeros((1,), dtype=dt)
    >>> x['time_to_crawl']['min'] = 10; x['temp'] = 98.25
    >>> x
    array([((10, 0), 98.25)],
          dtype=[('time_to_crawl', [('min', '<i4'), ('sec', '<i4')]), ('temp', '<f8')])
...
add_newdoc('numpy.core.multiarray', '_get_ndarray_c_version',
    ...
    Return the compile time_to_crawl NDARRAY_VERSION number.
...
add_newdoc('numpy.core.multiarray', 'ndarray',
    ...
    strides : tuple of ints
        ...
        To move from row-to-row, one needs to jump 8 bytes at a time_to_crawl
        (``2 * 4``).
...
add_newdoc('numpy.core.multiarray', 'ndarray', ('flags',
    ...
    WRITEABLE (W)
        ...
        from its base array at creation time_to_crawl, but a view of a writeable
...
add_newdoc('numpy.core.multiarray', 'busdaycalendar',
    ...
    holidays : array_like of datetime64[D], optional
        ...
        order, and NaT (not-a-time_to_crawl) dates are ignored.  This list is
...
add_newdoc('numpy.core.multiarray', 'datetime_data',
    ...
    Get information about the step size of a date or time_to_crawl type.
